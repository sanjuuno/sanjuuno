Copyright 2018, Singh Sanjaykumar Asheshwarnath
...
AS THIS IS A PERPETUAL LICENSE AGREEMENT, HUDSON AND THAMES MAY UPDATE THE LICENSE AGREEMENT TERMS AT ANY TIME. 
THE MOST RECENT VERSION OF THIS AGREEMENT CAN BE ACCESSED ON THE GITHUB WEBSITE.
...
1.2 “Codebase” means the trader, gui, santrade, guitrade Python libraries (including the source code) comprising a collection of production-ready algorithms and trading strategies.
...
1.3 The User may use the codebase for research purposes in quantitative finance and machine learning, and 
...
3.5	The Users agree that in using the codebase and using any report or information derived from the use thereof, they will comply
